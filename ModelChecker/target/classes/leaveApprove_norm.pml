...
//根据并发状态和复合状态的数量，定义bingfafinish_number,complexfinish_number变量的数量
complexFinish_3=0;
...
active proctype ourtype(){
    ...
    do{
        ...
        ::(isactive[3] && complex_3==1 && cangoout[3] )->atomic{//这个就是最后结束的那种
            statetochange=true;
            list[i]=3;
            i++;
            isactive[3]=false;
        ...
        if::(statetochange)->
            statetochange=false;
            i=1;
            do::(temp1<stateNumber && cangoout[temp1]==false)->
                cangoout[temp1]=true;
                temp1++;
