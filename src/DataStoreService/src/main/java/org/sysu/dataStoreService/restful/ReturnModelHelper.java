...
import org.sysu.dataStoreService.GlobalContext;
...
public class ReturnModelHelper {
    ...
    public static void StandardResponse(ReturnModel rnModel, StatusCode code, String retStr) {
        ...
        rnModel.setServiceId(String.format("%s %s", TimestampUtil.GetTimestampString(), GlobalContext.DATA_STORE_GLOBAL_ID));
